                ...
                <div class="col-12">
                    <div class="card">
                                ...
                                <div class="d-flex">
                                    <div class="ms-auto text-muted">
                                        <div class="ms-2 d-inline-block">
                                            <input type="date" class="form-control form-control-sm" id="start_date" wire:model="filter_date" aria-label="Start Date" placeholder="Start Date" value="{{ date('Y-m-d') }}">
                                        </div>
                                    </div>
                                    {{-- <div class="ms-auto text-muted">
                                        <div class="ms-2 d-inline-block">
                        ...
                        <div class="table-responsive">
                            <table id="treegrid" role="treegrid" class="table table-sm table-striped" 
                                <colgroup>
                                ...
                                <tbody>
                                    ...
                                    <tr role="row" aria-level="1" aria-posinset="1" aria-setsize="2" aria-expanded="false">
                                        <td role="gridcell">
                                            <a id="btn-posting{{ $idx }}" title="Posting Transaksi" onclick="postingItem({{ $idx }})">
                                        ...
                                        <td colspan="4" style="text-align: right"  role="gridcell">{{ ($trans['summary']->total_qty) }}</td>
                                    </tr>
                                    ...
                                    <tr role="row" aria-level="2" aria-posinset="1" aria-setsize="15" class="hidden text-nowrap">
                                        <td role="gridcell">
                                                ...
                                                <a title="Edit Transaction" wire:click="$dispatch('openEdit', [{{ $detail->id ?? ''}}])" data-bs-toggle="modal" data-bs-target="#modal-large">
