                ...
                <form wire:submit.prevent="store">
                    ...
                    <div class="modal-body">
                        <div class="col-12 mb-3">
                            ...
                            <select wire:model.live="company" class="form-select" required>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input type="text" class="form-control" wire:model="activityCode" placeholder="Code" required oninput="this.value = this.value.toUpperCase()">
                        </div>
                        <div class="col-12 mb-3">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea name="" id="" cols="30" rows="3" class="form-control" wire:model="notes">
