                ...
                <form wire:submit.prevent="store">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <select wire:model="plant" wire:key="{{ $selectedCompany }}" class="form-select"
                                required>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input type="text" class="form-control" wire:model="equipmentNo" placeholder="Code" required oninput="this.value = this.value.toUpperCase()">
                        </div>
                        <div class="col-12 mb-3">
                            <label for="" class="form-label required">Equipment Desription</label>
                            <input type="text" class="form-control" wire:model='equipmentDesc' placeholder="Name" required>
                        </div>
                    </div>
