...
class Dashboard extends Component
{
    public function render()
    {
        ...
        if ($latestPeriod) {
            $quotaCompany = Quota::with('company')->where('period_id',$latestPeriod->id)->get();
        }else{
            $quotaCompany = [];
        }
        ...
        return view('livewire.dashboard',compact('maxCapacity','materialStock','totalFuel','companyStock','quotaCompany'));
    }
}
